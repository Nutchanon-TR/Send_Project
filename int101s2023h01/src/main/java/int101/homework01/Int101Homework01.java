...
public class Int101Homework01 {
   ...
   static void work03UseOfUtilityClass() {
      ...
      */
       System.out.println("CalculateBMI is weight/(height*height) = " + MyUtil.calculateBMI (50, 180));
       System.out.println("Average is (v1+v2+v3)/3 = " + MyUtil.average(10, 20, 30));
   }
   ...
   static void work04UseOfObjectClass() {
      ...
      */
      ...
      Person B1 = new Person(117);
      Person B2 = new Person(116);
      BankAccount b1 = new BankAccount(5555,B1);
      BankAccount b2 = new BankAccount(2213,B2);

      System.out.println("ID of B1 is : " + B1.getId());
      System.out.println("ID of B1 is : " + B2.getId());
      
       b1.deposit(500);
       System.out.println("Before transfer.");
       System.out.println("B1 have money "+ b1.getBalance());
       System.out.println("B1 have money "+ b2.getBalance());
       ...
       b2.withdraw(300);
       System.out.println("After withdraw b2 300.");
       System.out.println("B2 have money : " + b2.getBalance());
